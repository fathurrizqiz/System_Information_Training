...
const lihatDokumen = (bukti_hadir: string | null) => {
    if (bukti_hadir && bukti_hadir !== 'null') {
        window.open(`/storage/${bukti_hadir}`, '_blank');
    } else {
        toast.error('Dokumen bukti belum diunggah.');
    }
};
